...
Name:           ros-galactic-turtlebot4-examples
Version:        0.1.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS turtlebot4_examples package

License:        Apache 2.0
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-galactic-turtlebot4-cpp-examples
Requires:       ros-galactic-turtlebot4-python-examples
Requires:       ros-galactic-ros-workspace
BuildRequires:  ros-galactic-ament-cmake
BuildRequires:  ros-galactic-turtlebot4-cpp-examples
BuildRequires:  ros-galactic-turtlebot4-python-examples
